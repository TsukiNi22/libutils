...
class FatalException: public utils::exception::AException {
    public:
        ...
        // ---------- Constructor --------- //
        _cold explicit FatalException(utils::exception::Code code = utils::exception::Code::Undefined, std::source_location loc = std::source_location::current()) noexcept : AException(loc, utils::exception::Type::Error | utils::exception::Type::Fatal, code)
        {
            std::cerr
        ...
        _cold FatalException(utils::exception::Type type = utils::exception::Type::None, utils::exception::Code code = utils::exception::Code::Undefined, std::string info = "[None]", std::source_location loc = std::source_location::current()) noexcept : AException(loc, type | utils::exception::Type::Fatal, code, info)
        {
            std::cerr
            << EXCEPTION_ABORTED_HEADER  << std::endl
            << this->formated()          << std::endl
