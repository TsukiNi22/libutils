...
enum class InternalCode: std::size_t {
    ...
    NoCompliantUsage = 10777293338727669834ull,
    ArgParserHook = 1447770066311267634ull,
    OptionsNumber = 10358458443507198506ull,
    FlagOptionsNumber = 6015277952083864973ull,
    Option = 14928537144434518850ull,
